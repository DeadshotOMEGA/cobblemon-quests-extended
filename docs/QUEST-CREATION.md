...
| Heal             | heal             | Triggers when a Pokémon is healed.                                                              |
| Hatch Egg        | hatch_egg        | Triggers when an egg hatches.                                                                   |

### Mega Showdown Integration Actions

These actions require the [Cobblemon: Mega Showdown](https://modrinth.com/mod/mega-showdown) mod to be installed:
...
All the conditions below stack on top of each other.
...
### Extended Conditions (New)

| Condition       | Parameter name | Type           | Description                                                                                     |
| --------------- | -------------- | -------------- | ----------------------------------------------------------------------------------------------- |
| Tera Type       | tera_type      | List\<String\> | The Tera type of the Pokémon. Values: `normal`, `fire`, `water`, `grass`, `electric`, `ice`, `fighting`, `poison`, `ground`, `flying`, `psychic`, `bug`, `rock`, `ghost`, `dragon`, `dark`, `steel`, `fairy`, `stellar` |
| Mega Form       | mega_form      | List\<String\> | The Mega Evolution form. Values: `mega`, `mega-x`, `mega-y`, `primal`                           |
| Z-Crystal       | z_crystal      | List\<String\> | The Z-Crystal used. See [Z-Crystal values](#z-crystal-values) for full list.                    |
| Dynamax Type    | dynamax_type   | List\<String\> | The Dynamax form type. Values: `dynamax`, `gigantamax`                                          |
...
## Extended Quest Examples

### Mega Evolution Quest

Create a quest that requires the player to Mega Evolve Charizard into Mega Charizard X:
...
Create a quest to Terastallize any Pokémon with Fire Tera type:
...
Create a quest to use a specific Z-Move:
...
### Dynamax Quest (Requires Mega Showdown)

Create a quest to Gigantamax a specific Pokémon:
...
Create a quest to hatch shiny Pokémon:
